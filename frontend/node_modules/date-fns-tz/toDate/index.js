...
var _index = require('date-fns/_lib/toInteger/index.js');

var _index2 = _interopRequireDefault(_index);

var _index3 = require('date-fns/_lib/getTimezoneOffsetInMilliseconds/index.js');
...
var patterns = {
  ...
  if (date) {
    ...
    if (dateStrings.timezone || options.timeZone) {
      offset = (0, _tzParseTimezone2.default)(dateStrings.timezone || options.timeZone, new Date(timestamp + time));
      if (isNaN(offset)) {
        return new Date(NaN);
      }
    } else {
